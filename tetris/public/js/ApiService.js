...
class ApiService {
    constructor() {
        ...
        console.log('ApiService initialisé avec baseUrl:', this.baseUrl, 'hostname:', window.location.hostname);
        ...
        // Callbacks pour les changements d'état d'authentification
        this.authStateChangeCallbacks = [];
        
        // Promise pour le chargement initial
        this.initialLoadPromise = null;
        
        // Charge l'utilisateur si token présent
        if (this.token) {
            this.initialLoadPromise = this.loadCurrentUser().catch(() => {
                // Ignore les erreurs de chargement initial
                console.log('Échec du chargement initial de l\'utilisateur');
            });
        } else {
            this.initialLoadPromise = Promise.resolve();
        }
    }

    /**
     * Attend que le chargement initial de l'utilisateur soit terminé
     */
    ...
    /**
     * Notifie tous les callbacks d'un changement d'état d'authentification
     */
