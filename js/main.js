...
class BlockDropApp {    /**
     ...
     */      constructor() {
        ...
        this.userSettingsMenu = new UserSettingsMenu(this.appContainer);
    ...
    setupCallbacks() {
        ...
        this.mainMenu.setUserSettingsCallback(() => this.showUserSettings());
    ...
    /**
     * Affiche les paramètres utilisateur (RGPD)
     */
    showUserSettings() {
        this.currentState = 'user-settings';
        this.userSettingsMenu.render();
    }    /**
...
window.onload = async () => {   window.blockDropApp = new BlockDropApp();
   
   // Attend que l'utilisateur soit chargé depuis le localStorage
   if (window.apiService) {
       await window.apiService.waitForInitialLoad();
   }
